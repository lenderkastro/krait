...
export const BLOG_POSTS = [
  {
    ...
    excerpt: "Why peer-to-peer (P2P) trading is slow and how automated settlement rails are changing the landscape.",
    date: "July 17, 2026",
    readTime: "5 min read",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. All transactions are handled by automated payment rails and escrow smart contracts. No human middleman holds or handles your crypto or Naira, preventing manual errors, delays, or peer-to-peer security risks.",
  },
];
...
export function TelegramButton({
  ...
  const variants = {
    ...
    accent:
      "bg-accent text-accent-foreground hover:bg-accent/90 hover:shadow-accent/20 glow-neon",
    secondary:
      "bg-secondary text-secondary-foreground hover:bg-secondary/90 hover:shadow-secondary/20 border border-border",
    ghost:
      "border border-border/80 text-foreground hover:bg-secondary hover:border-foreground/30",
  };
  return (
    <a
      href={TG_URL}
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col items-center px-6 text-center">
        ...
        >
          <span className="relative flex h-2.5 w-2.5">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full opacity-75" style={{ background: "var(--krait)" }} />
            <span className="relative inline-flex h-2.5 w-2.5 rounded-full" style={{ background: "var(--krait)" }} />
          </span>
          <span className="text-[10px] font-bold uppercase tracking-widest font-mono text-primary">
            AUTOMATED CRYPTO TO NAIRA SETTLEMENT
          </span>
        </div>
        ...
        <p className="mt-8 max-w-xl text-balance text-base sm:text-lg leading-relaxed text-muted-foreground">
          Sell USDT, BTC, ETH, and other assets instantly to any Nigerian bank. Fully automated payout rails. Backed by an automated timing guarantee.
        </p>
        ...
        <div className="mt-20 grid w-full max-w-4xl grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="flex flex-col items-center p-6 rounded-2xl glass-card border border-border/40">
            ...
            <p className="mt-2 text-xs text-muted-foreground">Under 5 minutes average, running on completely automated payment rails.</p>
          </div>
          <div className="flex flex-col items-center p-6 rounded-2xl glass-card border border-border/40">
            ...
            <p className="mt-2 text-xs text-muted-foreground">Zero onboarding friction. Initiate trades and get paid immediately via Telegram.</p>
          </div>
          <div className="flex flex-col items-center p-6 rounded-2xl glass-card border border-border/40">
            <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center text-primary text-xl">
            ...
            <p className="mt-2 text-xs text-muted-foreground">If the transaction takes longer than 5 minutes, we pay you a rate bonus.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <div className="font-mono text-xs font-bold uppercase tracking-widest text-primary">Live Exchange Rate</div>
            <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
              Calculate your payout instantly.
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              We charge a flat 3% markup already factored into our competitive rates. The rate you lock in is exactly what lands in your bank account — no hidden fees, no blockchain gas surcharges.
            </p>
            <div className="space-y-4 pt-4 border-t border-border/40">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">Payouts to OPay, Kuda, GTBank, and all primary banks</span>
              </div>
            </div>
          </div>

          <div className="glass-card rounded-3xl border border-border/60 p-8 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 p-4 font-mono text-[10px] tracking-widest text-muted-foreground">KRT_CALC_V1</div>
            
            <div className="space-y-6">
              {/* Asset Select */}
              <div>
                <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Asset to Sell</label>
                <div className="mt-2 grid grid-cols-5 gap-2">
                  {ASSETS.map((asset) => {
                    ...
                    return (
                      ...
                      >
                        <AssetIcon className={`h-7 w-7 mb-1.5 ${isSelected ? "brightness-100" : "opacity-80 group-hover:opacity-100"}`} />
                        <span className="block text-[11px] font-mono tracking-wide">{asset.sym}</span>
                      </button>
                    );
                  })}
                </div>
              ...
              <div>
                <div className="flex justify-between items-baseline">
                  <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Amount to Sell</label>
                  <span className="text-[10px] text-muted-foreground font-mono">Min: {selectedAsset.min} {selectedAsset.sym}</span>
                </div>
              ...
              <div className="p-4 rounded-2xl bg-secondary/5 border border-border/40 flex justify-between items-center">
                <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Current Rate</span>
              ...
              {/* Payout Target */}
              <div>
                <label className="text-xs font-bold tracking-wider uppercase text-muted-foreground">Guaranteed Naira Settlement</label>
              ...
              <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  {copied ? <Check className="h-4.5 w-4.5 text-accent" /> : <Copy className="h-4.5 w-4.5 text-muted-foreground" />}
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-4 text-muted-foreground">
            No websites to log into, no apps to download. Click on a step below to view the actual bot screens.
          </p>
        </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="space-y-4">
            {steps.map((step, idx) => (
              ...
              >
                <h3 className={`font-bold text-lg ${activeStep === idx ? "text-primary" : "text-foreground"}`}>
                  {step.title}
                </h3>
...
function SocialProofTicker() {
  const [trades, setTrades] = useState<any[]>([
    { id: "krt_a82f", asset: "USDT", amount: "350", payout: "₦567,000", time: "2m 14s", status: "settled" },
    { id: "krt_29be", asset: "SOL", amount: "12.5", payout: "₦3,625,000", time: "3m 45s", status: "settled" },
    { id: "krt_e901", asset: "BTC", amount: "0.015", payout: "₦1,656,000", time: "1m 58s", status: "settled" },
    { id: "krt_92d1", asset: "USDT", amount: "1,200", payout: "₦1,944,000", time: "2m 51s", status: "settled" },
  ]);
          ...
          {trades.map((trade) => (
            ...
            >
              ...
              <div>
                ...
                <span className="font-bold text-foreground">{trade.amount} {trade.asset}</span>
    ...
    <section id="proofs" className="border-b border-border/40 py-24 bg-background">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-4 text-muted-foreground">
            Transparency is central to Krait. Here are real-world transaction logs and system dashboards.
          </p>
        </div>

        <div className="grid gap-8 md:grid-cols-3">
          {PROOFS.map((proof, idx) => (
            <div key={idx} className="flex flex-col bg-card border border-border/60 rounded-3xl overflow-hidden shadow-lg hover:border-primary/40 transition-all duration-300">
              {/* Screenshot Wrapper */}
        ...
        <div className="glass-card rounded-[32px] border border-border/60 p-8 md:p-16 relative overflow-hidden">
          ...
          <div className="relative grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We believe speed should be guaranteed, not just promised. If Naira does not hit your bank account within 5 minutes of your cryptocurrency deposit confirming on-chain, we automatically credit a 1% payout bonus on your transaction.
              </p>
            ...
            <div className="relative mx-auto w-full max-w-[340px]">
              <div className="rounded-2xl bg-card border border-border/60 p-6 font-mono text-xs shadow-2xl space-y-4">
                ...
                <div className="flex items-baseline justify-between pt-2">
                  <span className="text-muted-foreground uppercase text-[10px]">Guaranteed Window</span>
  ...
  return (
    <section id="referral" className="border-b border-border/40 py-24 bg-secondary/5">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <div className="font-mono text-xs font-bold uppercase tracking-widest text-primary">Passive Income</div>
            <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl leading-tight font-display">
              Earn 30% for life.<br />
              No caps. No expiry.
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Refer professionals to Krait. When they swap crypto, you earn a recurring 30% cut of our 3% markup on every trade they complete. Instantly credited to your commission wallet.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4">
              <div className="bg-card border border-border/40 rounded-2xl p-4 text-center">
                ...
                <div className="text-[10px] uppercase tracking-wider text-muted-foreground mt-1">markup cut</div>
              </div>
              <div className="bg-card border border-border/40 rounded-2xl p-4 text-center">
                <div className="text-2xl font-extrabold text-primary font-display">∞</div>
                <div className="text-[10px] uppercase tracking-wider text-muted-foreground mt-1">no expiry</div>
              </div>
              <div className="bg-card border border-border/40 rounded-2xl p-4 text-center">
                <div className="text-2xl font-extrabold text-primary font-display">$0</div>
                <div className="text-[10px] uppercase tracking-wider text-muted-foreground mt-1">caps or limits</div>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card rounded-3xl border border-border/60 p-8 shadow-2xl space-y-6">
            <div>
              <div className="flex justify-between items-baseline">
                ...
                <span className="font-mono text-sm font-bold text-foreground">${volume.toLocaleString()}</span>
              </div>
              <input
                type="range"
                min="1000"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-secondary/15 border border-border/40 p-5 rounded-2xl">
                <div className="text-xs text-muted-foreground uppercase tracking-wider">Estimated USD Commission</div>
                <div className="text-2xl font-extrabold font-display text-foreground mt-2">
                  ${commissionUsd.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
              ...
              <div className="bg-accent/5 border border-accent/20 p-5 rounded-2xl">
                <div className="text-xs text-accent uppercase tracking-wider">Estimated NGN Payout</div>
    ...
    <section id="assets" className="border-b border-border/40 py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-4 text-muted-foreground">
            We support the primary liquid stablecoins and standard native crypto assets across major Layer-1 and Layer-2 networks.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-5">
          {ASSETS.map((asset) => {
            const AssetIcon = asset.icon;
            return (
              <div key={asset.sym} className="rounded-2xl border border-border/60 bg-card p-6 flex flex-col items-center text-center shadow-lg relative overflow-hidden group hover:border-primary/40 transition-all duration-300">
        ...
        <div className="mt-12">
          <h4 className="text-center font-mono text-[10px] font-bold uppercase tracking-wider text-muted-foreground mb-4">Supported Blockchains</h4>
          <div className="flex flex-wrap justify-center gap-2">
            {NETWORKS.map((network) => (
              <span key={network} className="px-4 py-2 border border-border/40 rounded-full font-mono text-[11px] text-muted-foreground bg-secondary/10">
                {network}
              </span>
            ))}
          </div>
    ...
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl px-6 text-center space-y-8 relative">
        ...
        <p className="max-w-lg mx-auto text-muted-foreground text-base sm:text-lg leading-relaxed">
          Open Telegram, initiate your trade, and let our automated payment rails settle your cash immediately.
        </p>
        ...
        <div className="flex flex-wrap gap-x-12 gap-y-6">
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#calculator" className="hover:text-foreground transition-colors">Live Rate Calculator</a></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><a href={TG_URL} target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">Contact Support</a></li>
              <li><span className="opacity-60">Terms & Privacy</span></li>
            </ul>
          </div>
        </div>
      </div>
...
export function BitcoinIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M19.78 12.35c.34-.33.56-.76.56-1.34 0-1.22-.87-2.02-2.3-2.2v-1.7h-1.2v1.7h-1.07V7.11h-1.2v1.7H12.2V10.2h1.15c.67 0 .8.27.8.69v8.43c0 .28-.15.48-.68.48H12.2v1.43h2.36v1.73h1.2v-1.73h1.08v1.73h1.2v-1.73c1.78-.17 2.76-1 2.76-2.5 0-1.12-.66-1.89-1.82-2.18 1.05-.3 1.78-1.05 1.78-2.24 0-.03 0-.06-.02-.09zm-4.37-2.42h1.8c.6 0 .97.35.97.91s-.37.91-.97.91h-1.8v-1.82zm2.14 8.04h-2.14V15.9h2.14c.67 0 1.08.38 1.08.97 0 .61-.41 1.01-1.08 1.01z" fill="white" />
      <defs>
        <linearGradient id="btcGradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
...
export function EthereumIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M16 5l-5.6 9.3 5.6 3.3 5.6-3.3L16 5zm0 18.2L10.4 16 16 19.3l5.6-3.3-5.6 7.2z" fill="white" fillOpacity="0.8" />
      <path d="M16 5v12.6l5.6-3.3L16 5zm0 13.3v4.9l5.6-7.2-5.6 2.3z" fill="white" />
      <defs>
        <linearGradient id="ethGradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
...
export function TetherIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M17.92 11.23h3.58V8.65H10.5v2.58h3.58v4.32c-2.48.15-4.28.62-4.28 1.22 0 .58 1.8 1.05 4.28 1.22v4.86h3.84v-4.86c2.48-.17 4.28-.64 4.28-1.22s-1.8-1.07-4.28-1.22v-4.32zM16 16.92c-1.92 0-3.48-.3-3.48-.68s1.56-.68 3.48-.68 3.48.3 3.48.68-1.56.68-3.48.68z" fill="white" />
      <defs>
        <linearGradient id="usdtGradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
...
export function SolanaIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22.5 10.3c-.1-.1-.3-.2-.5-.2H9.8c-.3 0-.5.2-.6.4-.1.2 0 .5.2.7l2.3 2.3c.1.1.3.2.5.2H22c.3 0 .5-.2.6-.4.1-.2 0-.5-.2-.7l-.9-.9zm-13 7.8c-.1-.1-.3-.2-.5-.2H9.8c-.3 0-.5.2-.6.4-.1.2 0 .5.2.7l2.3 2.3c.1.1.3.2.5.2H22c.3 0 .5-.2.6-.4.1-.2 0-.5-.2-.7l-12.7-2.6zm3.2-3.9H9.8c-.3 0-.5.2-.6.4-.1.2 0 .5.2.7l2.3 2.3c.1.1.3.2.5.2H22c.3 0 .5-.2.6-.4.1-.2 0-.5-.2-.7l-12.2-2.5z" fill="white" />
      <defs>
        <linearGradient id="solGradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
...
export function LitecoinIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M19.8 19.3h-4.3l.8-3.1 1.7-.6.5-1.9-1.7.6.7-2.8H15l-.7 2.8-1.5.6-.5 1.9 1.5-.6-.8 3.1H9.8l-.5 1.9h10l.5-1.9z" fill="white" />
      <defs>
        <linearGradient id="ltcGradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
